    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Trading Application}
            {Built React, AgGrid, and Redis trading application for fixed income traders to receive and act on real-time analytics. Application supports thousands of updates per second, user customization, and authentication.}
